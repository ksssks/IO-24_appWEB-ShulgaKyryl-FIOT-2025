    ...
    return (
        <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
            ...
            <ul className='hidden md:flex items-start gap-5 font-medium'>
                ...
                <NavLink to={'/IO-24_appWEB-ShulgaKyryl-FIOT-2025/about'}>
                    <li className='py-1'>Про нас</li>
                    <hr className='border-none outine-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
                </NavLink>
                <NavLink to={'/IO-24_appWEB-ShulgaKyryl-FIOT-2025/contact'}>
                    ...
                    token
                        ...
                        <div className='absolute top-8 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                            <div className='min-w-48 bg-stone-200 rounded flex flex-col gap-4 p-4'>
                                <p onClick={()=>navigate('/IO-24_appWEB-ShulgaKyryl-FIOT-2025/my-profile')} className='hover:text-black'>Мій профіль</p>
                                <p onClick={()=>navigate('/IO-24_appWEB-ShulgaKyryl-FIOT-2025/my-appointments')} className='hover:text-black'>Мої сеанси</p>
                                <p onClick={()=>setToken(false)} className='hover:text-black'>Вийти</p>
                            </div>
                        </div>
                        </div> : <button onClick={() => navigate('/IO-24_appWEB-ShulgaKyryl-FIOT-2025/login')}
